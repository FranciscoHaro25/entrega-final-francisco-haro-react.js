    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-brand-text-soft mb-4 max-w-md">
              ...
              electrónica, deportes, ropa y libros con la mejor calidad y
              precio.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="text-brand-text-soft hover:text-secondary transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col justify-center items-center">
          <p className="text-brand-text-soft text-sm text-center">
